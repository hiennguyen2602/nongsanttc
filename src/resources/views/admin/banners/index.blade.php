        ...
        <div class="x_content">
            <div class="table-responsive">
                <table class="table table-striped">
                    <thead><tr><th>Ảnh</th><th>Tiêu đề</th><th>Vị trí</th><th class="table-actions"></th></tr></thead>
                    <tbody>
                        @foreach ($banners as $banner)
                            <tr>
                                <td><img src="{{ store_media_url($banner->image, 'thumbnail') }}" class="h-12 w-20 rounded object-cover ring-1 ring-slate-200"></td>
                                <td>{{ $banner->title }}</td>
