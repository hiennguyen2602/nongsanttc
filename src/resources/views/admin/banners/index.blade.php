                        ...
                        @foreach ($banners as $banner)
                            <tr>
                                ...
                                <td class="table-actions">
                                    ...
                                    <form method="POST" action="{{ route('admin.banners.destroy', $banner) }}" class="inline" data-confirm-entity="banner" data-confirm-name="{{ $banner->title }}">@csrf @method('DELETE')<button type="button" class="btn btn-link btn-link-danger btn-sm" data-confirm-trigger>Xóa</button></form>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
