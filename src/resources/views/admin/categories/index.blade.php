                        ...
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td class="table-actions">
                                    ...
                                    <form method="POST" action="{{ route('admin.categories.destroy', $category) }}" class="inline" data-confirm-entity="danh mục" data-confirm-name="{{ $category->name }}">@csrf @method('DELETE')<button type="button" class="btn btn-link btn-link-danger btn-sm" data-confirm-trigger>Xóa</button></form>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
