            ...
            <div class="space-y-6 lg:col-span-2">
                <div>
                    ...
                    <ul class="space-y-4 text-sm text-slate-600">
                        ...
                        <li class="flex gap-3">
                            <span class="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-brand/10 text-brand">
                        ...
                        <li class="flex gap-3">
                            ...
                            <a href="tel:{{ preg_replace('/\s+/', '', store_setting('phone')) }}" class="font-medium text-brand hover:underline">{{ store_setting('phone') }}</a>
                        </li>
                        @endif
                        ...
                        <li class="flex gap-3">
                            ...
                            <a href="mailto:{{ store_setting('email') }}" class="font-medium text-brand hover:underline">{{ store_setting('email') }}</a>
                        </li>
                        @endif
                    </ul>
                </div>
