<div class="fixed bottom-24 right-4 z-40 flex flex-col gap-2 sm:bottom-8 sm:right-6">
    <a href="tel:{{ preg_replace('/\s+/', '', config('store.phone')) }}"
    ...
    <a href="{{ config('store.zalo') }}" target="_blank" rel="noopener"
       ...
       title="Zalo">Zalo</a>
    <a href="{{ config('store.maps') }}" target="_blank" rel="noopener"
    ...
    <a href="{{ config('store.messenger') }}" target="_blank" rel="noopener"
